...
<div id="modal-custom-1b" class="modalMenu menuModal">
	<div class="relative modal__content">
		<div class="flex flex-wrap w-full menuMobileModal">
			<!--Menu-->
			<?php
	...
	<div class="mobile__menu lg:hidden">
		<div class="container">
			<div class="flex items-center justify-center w-full md:px-0">
					...
					<div class="w-auto">
						<button data-iziModal-close>
							<svg width="43" height="44" viewBox="0 0 43 44" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<path d="M26.7886 27.7886L17.5962 18.5962M17.5962 27.7886L26.7886 18.5962" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
							</svg>
