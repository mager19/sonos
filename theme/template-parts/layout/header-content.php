...
?>
<header class="header__mobile lg:hidden">
	<div class="container">
...
<header id="masthead" class="absolute top-0 left-0 items-center hidden w-full lg:flex bg-heroBg main-hero">
	<div class="container">
		<div class="flex items-center justify-between">
			...
			<div class="w-2/3 menu__container">
